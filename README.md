...
- Security and safety alert applications
- Light-sensitive automation projects
- Basic embedded and IoT learning projects
...
- Helps in understanding sensor-based automation
- Can be used as a mini prototype for smart lighting systems
...
- Send alerts to **mobile or web dashboard**
- Combine with **motion sensor** for smart security system
- Convert into a complete **smart home automation project**
